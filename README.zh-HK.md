...
**V3.8**：手機固定底部分配欄、雙向桌位分配、緊湊單行完成桌、UI 設計偏好文件（[`docs/UI-DESIGN.md`](docs/UI-DESIGN.md)）。
...
- UI 設計偏好：[`docs/UI-DESIGN.md`](docs/UI-DESIGN.md)
- Changelog：[`CHANGELOG.md`](CHANGELOG.md)
- Roadmap：[`docs/ROADMAP.md`](docs/ROADMAP.md)
- 專案歷史：[`docs/PROJECT-HISTORY.md`](docs/PROJECT-HISTORY.md)
...
- Event / League 藍圖：[`docs/EVENTS-AND-LEAGUES.md`](docs/EVENTS-AND-LEAGUES.md)
