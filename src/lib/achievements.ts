...
export const CORE_ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  },
  {
    ...
    tiers: [
      ...
      { level: 2, threshold: 4, label: { 'zh-Hant': '4 副', 'zh-Hans': '4 副', en: '4 decks', ja: '4種' } },
      { level: 3, threshold: 6, label: { 'zh-Hant': '6 副', 'zh-Hans': '6 副', en: '6 decks', ja: '6種' } },
      { level: 4, threshold: 8, label: { 'zh-Hant': '8 副', 'zh-Hans': '8 副', en: '8 decks', ja: '8種' } },
      { level: 5, threshold: 10, label: { 'zh-Hant': '10 副', 'zh-Hans': '10 副', en: '10 decks', ja: '10種' } },
    ],
  },
  {
    id: 'set_collector',
  ...
  },
  {
    ...
    tiers: [
      ...
      { level: 5, threshold: 15, label: { 'zh-Hant': '15 人', 'zh-Hans': '15 人', en: '15 rivals', ja: '15人' } },
    ],
  },
  {
    id: 'session_marathon',
    ...
    tiers: [
      { level: 1, threshold: 4, label: { 'zh-Hant': '4 場', 'zh-Hans': '4 场', en: '4 games', ja: '4戦' } },
      { level: 2, threshold: 6, label: { 'zh-Hant': '6 場', 'zh-Hans': '6 场', en: '6 games', ja: '6戦' } },
      { level: 3, threshold: 8, label: { 'zh-Hant': '8 場', 'zh-Hans': '8 场', en: '8 games', ja: '8戦' } },
      { level: 4, threshold: 10, label: { 'zh-Hant': '10 場', 'zh-Hans': '10 场', en: '10 games', ja: '10戦' } },
      { level: 5, threshold: 12, label: { 'zh-Hant': '12 場', 'zh-Hans': '12 场', en: '12 games', ja: '12戦' } },
    ],
  },
  {
    id: 'note_poet',
    ...
    tiers: [
      ...
      { level: 2, threshold: 3, label: { 'zh-Hant': '3 場', 'zh-Hans': '3 场', en: '3 matches', ja: '3戦' } },
      { level: 3, threshold: 8, label: { 'zh-Hant': '8 場', 'zh-Hans': '8 场', en: '8 matches', ja: '8戦' } },
      { level: 4, threshold: 15, label: { 'zh-Hant': '15 場', 'zh-Hans': '15 场', en: '15 matches', ja: '15戦' } },
      { level: 5, threshold: 25, label: { 'zh-Hant': '25 場', 'zh-Hans': '25 场', en: '25 matches', ja: '25戦' } },
    ],
  },
  {
    id: 'comeback',
