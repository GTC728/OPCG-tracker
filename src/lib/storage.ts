  ...
  7: (state) => {
    ...
    return {
      ...
      settings: {
        ...
        statsScopeTab: settings.statsScopeTab ?? null,
        statsPeriodMode: settings.statsPeriodMode ?? null,
        statsPeriodPresetId: settings.statsPeriodPresetId ?? null,
        statsPeriodOpSubdivide: settings.statsPeriodOpSubdivide ?? false,
        statsPeriodYear: settings.statsPeriodYear ?? null,
        statsPeriodQuarter: settings.statsPeriodQuarter ?? null,
        statsPeriodCustomFrom: settings.statsPeriodCustomFrom ?? null,
        statsPeriodCustomTo: settings.statsPeriodCustomTo ?? null,
