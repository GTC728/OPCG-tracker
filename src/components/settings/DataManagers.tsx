...
import { IconDelete, IconEdit, IconLinked, IconManage } from '@/components/ui/LobbyIcons'
      ...
      <article className="flex items-center gap-2 rounded-xl bg-surface px-2.5 py-2 ring-1 ring-surface-muted">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-1.5">
            ...
            {linked ? (
              <span className="inline-flex shrink-0 text-brand-300" title={t('lobby.linkedBadge')}>
                <IconLinked />
              </span>
            ) : null}
          </div>
        ...
        <div className="flex shrink-0 gap-0.5">
          {showMemberActions && member ? (
            <IconButton label={t('lobby.manage')} disabled={memberBusy} onClick={() => setManageOpen(true)}>
              <IconManage />
            </IconButton>
          ) : null}
